...
-->
            ...
            <div class="form-group choosetypes col-sm-4 col-sm-offset-2" style="margin-top: 15px">
                ...
                <select class="form-control selectpicker chooseproduct" id="select-country" onchange="this.form.submit()" data-live-search="true" name="id" style="direction: ltr">
                    ...
                    @foreach(\App\product::all() as$key=>$value)
                        <option value="{{$value->id}}">{{$value->name_ar}}</option>
                    @endforeach
                </select>
            </div>
            </form>
        <form action="{{url("/kt/adminpanel/searchbyproductcategory")}}" method="get">
            <div class="form-group choosetypes col-sm-4 col-sm-offset-2" style="margin-top: 15px">
                <label for="email">ابحث بالقسم:</label>
                <select class="form-control selectpicker chooseproduct" id="select-country" onchange="this.form.submit()" data-live-search="true" name="id" style="direction: ltr">
                    <option value="0">ابحث ثم اختر القسم</option>
